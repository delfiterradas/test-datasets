...
- homo_sapiens
  ...
  - pacbio:
    ...
    - bam:
      ...
      - test_hifi_aligned_assembly.bam : Assembly of test_hifi.fastq.gz (using hifiasm) aligned to genome3.fasta (input for portello module).
      - test_hifi_aligned_assembly.bam.bai : BAM index for 'test_hifi_aligned_assembly.bam'
      - test_hifi_aligned_to_assembly.bam : Reads-to-assembly alignments using the assembly of test_hifi.fastq.gz with hifiasm (input for portello module).
