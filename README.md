...
- homo_sapiens
  ...
  - popgen:
    ...
    - hdl/sumstats/trait1_canonical.tsv: Synthetic toy HDL-format canonical summary statistics for trait 1, generated by `generate_toy_hdl_data.R` for HDL-compatible inputs.
    - hdl/sumstats/trait2_canonical.tsv: Synthetic toy HDL-format canonical summary statistics for trait 2, generated by `generate_toy_hdl_data.R` for HDL-compatible inputs.
  - svsig:
